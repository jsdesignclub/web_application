  ...
  return (
    <div className="flex justify-between p-4">
      ...
      <div className="w-1/2 bg-white p-4 rounded shadow-md">
        <h2 className="text-2xl font-bold mb-4">Add Product to Stock</h2>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <button type="submit" className="w-full bg-blue-500 text-white p-2 rounded-md">Add to Stock</button>
        </form>
      </div>

      {/* Right Container */}
      <div className="w-1/2 bg-white p-4 rounded shadow-md">
        <h2 className="text-2xl font-bold mb-4">Issue Order</h2>
